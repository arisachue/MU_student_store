...
https://user-images.githubusercontent.com/62860690/176509975-49c9a941-8765-4992-a1b7-06f222c3575e.mp4
...
Since this was my first time incorporating React.js into web development, the Fast Food and Twitter lab were extremely useful. I felt that the axios fetching/posting data and filtering the products were not covered in the labs.

* If you had more time, what would you have done differently? Would you have added additional features? Changed the way your project responded to a particular event, etc.
  
I would include a better reciept (one that lists all the products ordered with their prices) to display once the user submits an order. I would also attempt on the other stretch features, like displaying all the past orders.

* Reflect on your project demo, what went well? Were there things that maybe didn't go as planned? Did you notice something that your peer did that you would like to try next time?

I am very proud of my finished product! The website functionality currently is perfect, but if invalid props were passed into my components, I would have some errors in my website. I would like to try rendering a more appealing "loading" html (perhaps a gif of a circle moving) like some of my peers did.
...
As always, shout out to Phineas and Yilika for being so patient with the debugging process. A huge shout out to my fellow hotel-mates, Preeti and Robert, for working in the hotel lounge with me until past midnight and for never getting tired of my endless questions. Finally shout out to Christina and Rafael for being amazing table-mates, and MVP to Abiel for locating my bug by only listening to me explain my bug for 20 seconds (wow!).
